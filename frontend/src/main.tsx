...
import { EffectsProvider, primeEffects } from "./hooks/useEffects";
...
// Decide the effects level before first paint, so a machine that needs the
// cheap material never renders a frame of the expensive one.
primeEffects();
